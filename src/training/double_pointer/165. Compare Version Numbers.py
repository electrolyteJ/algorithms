...
if __name__ == '__main__':
    ...
    version1 = "1.01"
    version2 = "1.001"
    print('1', s.compareVersion(version1, version2))
    version1 = "1.0"
    version2 = "1.0.0"
    print('1', s.compareVersion(version1, version2))
    version1 = "0.1"
...
class Solution:
    def compareVersion3(self, version1: str, version2: str) -> int:#使用双指针节省了空间
    ...
    def compareVersion2(self, version1: str, version2: str) -> int:
        if not version1 or not version2:return 0
        # 时间复杂度O(n+m+max(n,m)) 空间复杂度O(n+m)
        nums1 = version1.split('.')
        nums2 = version2.split('.')
        m,n=len(nums1),len(nums2)
        for i in range(max(m,n)):
            v1 = int(nums1[i]) if i < m else 0
            v2 = int(nums2[i]) if i < n else 0
            if v1 > v2:
                return 1
            elif v1 < v2:
                return -1
